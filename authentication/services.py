...
# #             raise AuthenticationFailed("ACCOUNT_LOCKED")
...
#             user = CustomUser.objects.get(email=email)
#         except CustomUser.DoesNotExist:
#             raise APIException("INVALID_CREDENTIALS", "Invalid credentials.")
...
#         if action == "login":
#             response = Response(
#                 {"accessToken": tokens["accessToken"], "message": "Login successful"},
